    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        {steps.map((step, index) => (
          <div key={index} className="flex flex-col items-center text-center p-6 bg-zinc-900 rounded-2xl border border-zinc-800 transform transition-transform duration-300 hover:scale-105 hover:border-orange-500/50">
